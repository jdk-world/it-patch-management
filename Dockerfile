...
ADD target/it-patch-management-0.0.1-SNAPSHOT.jar /run/it-patch-management-0.0.1-SNAPSHOT.jar
...
ENTRYPOINT exec java -jar /run/it-patch-management-0.0.1-SNAPSHOT.jar

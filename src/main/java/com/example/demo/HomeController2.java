...
public class HomeController2 {
	...
	@CrossOrigin
	@ResponseBody
	public List<OrganizationComplianceModel> listMedicine() {
		List<OrganizationComplianceModel> medicineList = springBootJdbcController.getMedicines();
	...
	@CrossOrigin
	@ResponseBody
	public List<OrganizationComplianceModel> findMedicines(Model model, @RequestParam("medicineName") String medicineName) {
		medicineName = medicineName.trim();
		medicineName = StringUtils.removeEnd(medicineName, "*");
		medicineName = StringUtils.removeStart(medicineName, "*");
		List<OrganizationComplianceModel> filteredMedicineList = new ArrayList<OrganizationComplianceModel>();
		for (OrganizationComplianceModel currentMedicine : listMedicine()) {

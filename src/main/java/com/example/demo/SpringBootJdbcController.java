...
//SELECT * FROM springbootdb.slots where slot_start>='2022-08-31 11:00:00' and slot_end <= '2022-09-01 14:00:00';
	...
	public List<OrganizationComplianceModel> getMedicines() {
		int Id;
		String name;
		...
		List<OrganizationComplianceModel> medicines = new ArrayList<>();

		List<Map<String, Object>> rows = jdbc.queryForList(sql);

		for (Map row : rows) {
			OrganizationComplianceModel obj = new OrganizationComplianceModel();
